...
<head>
    ...
    <link rel="stylesheet" href="/frontend/vendor/sweetalert2/dist/sweetalert2.min.css"/>
        <script src="/frontend/vendor/sweetalert2/dist/sweetalert2.min.js"></script>
...
<body class=" sidebar_main_open sidebar_main_swipe">
    ...
    <aside id="sidebar_main">
        ...
        <div class="menu_section">
            <ul>
                ...
                <li title="Dashboard">
                    <a href="{{route('admin_division')}}">
                        <span class="menu_icon"><i class="material-icons">&#xE871;</i></span>
                        <span class="menu_title">Division</span>
                    </a>
                    
                </li>

                <li title="Dashboard">
                    <a href="{{route('admin_district')}}">
                        <span class="menu_icon"><i class="material-icons">&#xE871;</i></span>
                ...
                <li title="Dashboard">
                    <a href="{{route('admin_upzilla')}}">
                        <span class="menu_icon"><i class="material-icons">&#xE871;</i></span>
                        <span class="menu_title">Upzilla/Thana</span>
                    </a>
                </li>

                <li title="Dashboard">
                    <a href="{{route('admin_union')}}">
                        <span class="menu_icon"><i class="material-icons">&#xE871;</i></span>
                        <span class="menu_title">Union/Area</span>
                    </a>
                </li>

                <li title="Dashboard">
                    <a href="{{route('admin_village')}}">
                        <span class="menu_icon"><i class="material-icons">&#xE871;</i></span>
                        <span class="menu_title">Village/Sub-Area</span>
                    </a>
                </li>
    ...
    <script src="{{ url('/backend/bower_components/datatables-buttons/js/dataTables.buttons.js') }}"></script>
    <script src="{{ url('/backend/assets/js/custom/datatables/buttons.uikit.js') }}"></script>
    <script src="{{ url('/backend/bower_components/jszip/dist/jszip.min.js') }}"></script>
    <script src="{{ url('/backend/bower_components/pdfmake/build/pdfmake.min.js') }}"></script>
    <script src="{{ url('/backend/bower_components/pdfmake/build/vfs_fonts.js') }}"></script>
    <script src="{{ url('/backend/bower_components/datatables-buttons/js/buttons.colVis.js') }}"></script>
    <script src="{{ url('/backend/bower_components/datatables-buttons/js/buttons.html5.js') }}"></script>
    <script src="{{ url('/backend/bower_components/datatables-buttons/js/buttons.print.js') }}"></script>
    <script src="{{ url('/backend/assets/js/custom/datatables/datatables.uikit.min.js') }}"></script>
    <script src="{{ url('/backend/assets/js/pages/plugins_datatables.js') }}"></script>
