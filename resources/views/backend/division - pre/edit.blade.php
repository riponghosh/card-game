...
@section('content')
	...
	<div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10">
		    ...
		    @endif
            {{ Form::open(array('url' => 'admin/issue/cruelty/latestnews/update/'.$all_data->id,'method' => 'POST', 'role' => 'form' , 'class' => 'uk-form-stacked', 'id' => 'user_edit_form','files' => true)) }}
                            ...
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-1-2">
                                            <div class="parsley-row">
                                                <input type="text" id="title" name="title" required class="md-input" value="{{$all_data->title}}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="uk-grid">
                                        ...
                                        <div class="uk-width-4-5">
                                            <div class="parsley-row">
                                                <textarea class="md-input" id="summary" name="summary" required cols="10" rows="3" data-parsley-trigger="keyup" >{{$all_data->summary}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-4-5">
                                            <div class="parsley-row">
                                                <textarea class="md-input" id="description" name="description" required cols="10" rows="3" data-parsley-trigger="keyup" >{{$all_data->description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
