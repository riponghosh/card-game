                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-2-5">
                                            ...
                                            <input type="text" id="name" value="{{$data->name}}" name="name" readonly class="md-input" />
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-1-5 uk-vertical-align uk-text-center">
                                        ...
                                        <div class="uk-width-2-5">
                                            ...
                                            <input type="text"  value="{{$data->bn_name}}" id="bn_name" name="bn_name" readonly class="md-input" />
                                        </div>
                                    </div>
                                </div>
                            </div>
