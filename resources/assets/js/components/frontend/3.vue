    ...
    <div class="container">
		<div class="col-md-12">
			...
			<div class="playspace unselectable hearts" id="playspace" style="width: 793.8px; height: 588px; left: 31px; /*top: 34px;*/ top: -5px; opacity: 1;position: relative;">
			   ...
			   <!-- <div class="piece classic card spot-hand1 spotPrefix-hand id-back" style="z-index: 3000; background: transparent url(&quot;frontend/image/Cards/card_back.png&quot;) no-repeat scroll 0% 0% / contain; border-radius: 6px; left: 93px; top: 145px; width: 79px; height: 123px; transform: rotate(76deg);"></div>
			   <div class="piece classic id-back card spot-hand1 spotPrefix-hand" style="z-index: 3001; background: transparent url(&quot;frontend/image/Cards/card_back.png&quot;) no-repeat scroll 0% 0% / contain; border-radius: 6px; left: 97px; top: 160px; width: 79px; height: 123px; transform: rotate(79deg);"></div>
			   <div class="piece classic id-back card spot-hand1 spotPrefix-hand" style="z-index: 3002; background: transparent url(&quot;frontend/image/Cards/card_back.png&quot;) no-repeat scroll 0% 0% / contain; border-radius: 6px; left: 100px; top: 176px; width: 79px; height: 123px; transform: rotate(81deg);"></div>
			   <div class="piece classic id-back card spot-hand1 spotPrefix-hand" style="z-index: 3003; background: transparent url(&quot;frontend/image/Cards/card_back.png&quot;) no-repeat scroll 0% 0% / contain; border-radius: 6px; left: 102px; top: 192px; width: 79px; height: 123px; transform: rotate(83deg);"></div>
			   <div class="piece classic id-back card spot-hand1 spotPrefix-hand" style="z-index: 3004; background: transparent url(&quot;frontend/image/Cards/card_back.png&quot;) no-repeat scroll 0% 0% / contain; border-radius: 6px; left: 103px; top: 207px; width: 79px; height: 123px; transform: rotate(85deg);"></div>
			   <div class="piece classic id-back card spot-hand1 spotPrefix-hand" style="z-index: 3005; background: transparent url(&quot;frontend/image/Cards/card_back.png&quot;) no-repeat scroll 0% 0% / contain; border-radius: 6px; left: 104px; top: 223px; width: 79px; height: 123px; transform: rotate(88deg);"></div>

			   <div class="piece classic id-back card spot-hand1 spotPrefix-hand" style="z-index: 3006; background: transparent url(&quot;frontend/image/Cards/card_back.png&quot;) no-repeat scroll 0% 0% / contain; border-radius: 6px; left: 105px; top: 239px; width: 79px; height: 123px; transform: rotate(90deg);"></div>

			   <div class="piece classic card spot-hand1 spotPrefix-hand id-back" style="z-index: 3007; background: transparent url(&quot;frontend/image/Cards/card_back.png&quot;) no-repeat scroll 0% 0% / contain; border-radius: 6px; left: 104px; top: 255px; width: 79px; height: 123px; transform: rotate(92deg);"></div>
			   <div class="piece classic id-back card spot-hand1 spotPrefix-hand" style="z-index: 3008; background: transparent url(&quot;frontend/image/Cards/card_back.png&quot;) no-repeat scroll 0% 0% / contain; border-radius: 6px; left: 103px; top: 270px; width: 79px; height: 123px; transform: rotate(95deg);"></div>
			   <div class="piece classic id-back card spot-hand1 spotPrefix-hand" style="z-index: 3009; background: transparent url(&quot;frontend/image/Cards/card_back.png&quot;) no-repeat scroll 0% 0% / contain; border-radius: 6px; left: 102px; top: 286px; width: 79px; height: 123px; transform: rotate(97deg);"></div>
			   <div class="piece classic id-back card spot-hand1 spotPrefix-hand" style="z-index: 3010; background: transparent url(&quot;frontend/image/Cards/card_back.png&quot;) no-repeat scroll 0% 0% / contain; border-radius: 6px; left: 100px; top: 302px; width: 79px; height: 123px; transform: rotate(99deg);"></div>
			   <div class="piece classic card spot-hand1 spotPrefix-hand id-back" style="z-index: 3011; background: transparent url(&quot;frontend/image/Cards/card_back.png&quot;) no-repeat scroll 0% 0% / contain; border-radius: 6px; left: 97px; top: 317px; width: 79px; height: 123px; transform: rotate(101deg);"></div>
			   <div class="piece classic id-back card spot-hand1 spotPrefix-hand" style="z-index: 3012; background: transparent url(&quot;frontend/image/Cards/card_back.png&quot;) no-repeat scroll 0% 0% / contain; border-radius: 6px; left: 93px; top: 333px; width: 79px; height: 123px; transform: rotate(104deg);"></div> -->
    ...
    export default {
        ...
        methods: {
          basic() {
			...
			this.first_series=this.arr.slice(0, 17);
			this.second_series=this.arr.slice(17, 34);
			this.third_series=this.arr.slice(34, 52);
          ...
          card_check(check){
          	...
          	if ((check>=0&&check<=3) || (check>=13&&check<=16)||(check>=26&&check<=29)||(check>=39&&check<=42)){
	      		...
	      		if (check==0||check==13||check==26||check==39) {
	      			vm.term_count=4;
	      			vm.term=(vm.term==vm.first?vm.second:(vm.term==vm.second?vm.third:vm.first));
	      		}
      			...
      			if (vm.term_count==0) {
      				vm.term=(vm.term==vm.first?vm.third:(vm.term==vm.second?vm.first:vm.second));
      			}
      		}
          },
          win_card_add(){
          	...
          	if (vm.term_count==0&&vm.term==vm.first) {
          		vm.first_series=vm.first_series.concat(vm.second_lose_card).concat(vm.third_lose_card);
                ...
                vm.third_series = vm.third_series
                 ...
                 .concat(vm.third_lose_card.filter(x => !vm.third_series.includes(x)));   
          		...
          		vm.second_series=vm.second_series.concat(vm.first_lose_card).concat(vm.third_lose_card);
                ...
                vm.third_series = vm.third_series
                 ...
                 .concat(vm.third_lose_card.filter(x => !vm.third_series.includes(x)));
          		...
          		vm.third_series=vm.third_series.concat(vm.first_lose_card).concat(vm.second_lose_card);
          		vm.first_series = vm.first_series
                 .filter(x => !vm.first_lose_card.includes(x))
                 .concat(vm.first_lose_card.filter(x => !vm.first_series.includes(x)));
                 vm.second_series = vm.second_series
